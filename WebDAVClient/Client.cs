...
namespace WebDAVClient
{
    public class Client : IClient
    {
        ...
        private async Task<bool> Move(Uri srcUri, Uri dstUri, bool overwrite = false)
        {
        ...
        public async Task<bool> Copy(Uri srcUri, Uri dstUri, bool overwrite = false)
        {
        ...
        public async Task<Stream> GetWriteStreamAsync(long contentLength, string targetAbsolutePath)
        {
        ...
        public async Task<Stream> GetReadStreamAsync(string resourceHref)
        {
